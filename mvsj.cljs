...
(defn angle-measurement-primitive [params] (apply primitive :angle_measurement params))
(defn arrow-primitive [params] (apply primitive :arrow params))
(defn box-primitive [params] (apply primitive :box params))
(defn ellipse-primitive [params] (apply primitive :ellipse params))
(defn ellipsoid-primitive [params] (apply primitive :ellipsoid params))
(defn label-primitive [params] (apply primitive :label params))
(defn lines-primitive [params] (apply primitive :lines params))
(defn mesh-primitive [params] (apply primitive :mesh params))
(defn distance-measurement-primitive [params] (apply primitive :distance_measurement params))
(defn tube-primitive [params] (apply primitive :tube params))
